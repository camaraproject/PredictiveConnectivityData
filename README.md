...
* The latest public release is [r1.2](https://github.com/camaraproject/PredictiveConnectivityData/releases/tag/r1.2), with the following API versions:
  * **predictive-connectivity-data 0.1.0**
  [[YAML]](https://github.com/camaraproject/PredictiveConnectivityData/blob/r1.2/code/API_definitions/predictive-connectivity-data.yaml)  [[ReDoc]](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/camaraproject/PredictiveConnectivityData/r1.2/code/API_definitions/predictive-connectivity-data.yaml&nocors)  [[Swagger]](https://camaraproject.github.io/swagger-ui/?url=https://raw.githubusercontent.com/camaraproject/PredictiveConnectivityData/r1.2/code/API_definitions/predictive-connectivity-data.yaml)
...
* For changes see [CHANGELOG](https://github.com/camaraproject/PredictiveConnectivityData/tree/main/CHANGELOG)
